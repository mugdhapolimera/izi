...
Z_path = 'C:/Users/mugdhapolimera/Desktop/UNC/Courses/Research/Codes/results/IZI_Z_multi.txt'
q_path = 'C:/Users/mugdhapolimera/Desktop/UNC/Courses/Research/Codes/results/IZI_q_multi.txt'
#f3 = open("/afs/cas.unc.edu/users/m/u/mugpol/Documents/IZI/izi/results/IZI_results2.pkl", "w")  
d_path = 'C:/Users/mugdhapolimera/Desktop/UNC/Courses/Research/Codes/results/IZI_results_multi.pkl'
...
d = izi_multi(Z_path, q_path, d_path, infile, fluxnames, errornames, idin, 
              plot_flag = 0, print_flag = 0, method = 'gpy')
#print d
t2 = time.time()
print t2-t1